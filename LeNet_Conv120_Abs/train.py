...
# tf.keras.utils.plot_model(model,show_layer_activations=True,show_shapes=True,to_file='model.png4')
...
print('UltratinyLeNet+Abs: loss,accuracy:',model_lenet.evaluate(cc.x_test,cc.y_test,verbose=0),
